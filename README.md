...
Compose. Dos agentes implementados y verificados de punta a punta:
Investigador de Producto (con proveedor real Gemini) y Analítica
Básica (agregación de solo lectura, sin proveedor de IA). Backend
documentado en docs/004-Backend, incluyendo el patrón de 6 pasos
para agregar el próximo agente.
```
